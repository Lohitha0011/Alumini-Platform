...
const AlumniSidebar = ({showAlumniHandler, showEventsHandler, showDashboardHandler}) => {
  return (
    <div className='shadow bg-steel-blue max-md:hidden min-h-screen'>
        <ul className='flex flex-col gap-6 mx-8 text-lg font-Montserrat mt-6 '>
            ...
            <li className='w-28 hover:bg-white hover:text-charcoal px-2 rounded-md py-1 text-white cursor-pointer'>Donation</li>
